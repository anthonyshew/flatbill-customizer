            ...
            return (
                <>
                    <svg className={className} onClick={handleClick} viewBox="0 0 396 442" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" alt="Solid Jersey Model.">
                        ...
                        <image height="200" width="200" className={`${className === 'avatar' ? "avatar " : null}display-image left`} href={leftArmLogo} alt="Left arm logo display." clipPath="url(#left-logo-cut)" />
                        <image className={`${className === 'avatar' ? "avatar " : null}display-image right`} href={rightArmLogo} alt="right arm logo display." />
                    </svg>
                </>
            )
        case "solid-back":
